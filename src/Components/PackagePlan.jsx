    ...
    return (
        <div className='py-20'>
            ...
            <div className='grid grid-cols-3 w-[80%] mx-auto gap-10 py-5'>
                ...
                <div className='text-white bg-gradient-to-r from-[#4F39F6] to-[#9514FA] p-5 rounded-xl'>
                    ...
                    <button className="btn bg-white text-purple-600 rounded-full btn-block">Get Started Free</button>
                </div>
                <div className='bg-base-200 p-5 rounded-xl'>
